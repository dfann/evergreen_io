...
describe('createNewUser', () => {
  ...
  it('should require a username', async () => {
    const requestOptions = { body: { email: testEmail, password: testPassword } };
    ...
    const responseBody = { "context": { "key": "username", "label": "username" }, "message": "\"username\" is required", "path": ["username"], "type": "any.required" };
